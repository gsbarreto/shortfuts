...
> {
  ...
  componentDidMount() {
    ...
    chrome.identity.getProfileUserInfo((userInfo) => {
      const paidUsers = ["martellaj@gmail.com", "gsbarretobr@gmail.com"];
      ...
      <div style={{ marginLeft: "12px" }}>
        ...
        >
          ...
          {!this.state.isPremium && (
            ...
            >
              In-app purchasing is not available in all countries. If you're
              unable to purchase, please send us an email at
              shortfuts@gmail.com.
            </span>
          )}
        </div>
        ...
        <div style={{ marginBottom: "12px" }}>
          ...
          <p style={{ fontSize: "10px", marginTop: "0px" }}>
            If ON, we'll add a <i>very</i> short delay so it's less likely EA
            will think you're a bot. Be aware that the chance of a ban gets
            significantly higher if you turn this OFF.
          </p>
        </div>
        ...
        <div>
          ...
          />
          <p style={{ fontSize: "10px", marginTop: "0px" }}>
            We'll warn if you're searching faster than we think you should be.
            If you're searching <i>too</i> quickly, EA will think you're a bot.
          </p>
        </div>
      </div>
    );
