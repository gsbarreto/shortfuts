    ...
    componentDidMount() {
        ...
        chrome.storage.sync.get("announcementVersion", data => {
            ...
            if (
                ...
                this.setAnnouncement(
                    `This new update (v5.5.1) includes added support for Portuguese as well as an anti-ban warning (where you'll be warned if you're spamming the transfer market too much).`,
