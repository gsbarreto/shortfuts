      ...
      chrome.storage.sync.get("shortcutsMap", data => {
        ...
        switch (shortcut) {
          ...
          case Shortcut.DECREASE_MAX:
            ...
            chrome.runtime.sendMessage({ decreaseMaxBidPrice: true });
            break;
          case Shortcut.DECREASE_MIN:
            provider.decreaseMinBidPrice();
            chrome.runtime.sendMessage({ decreaseMinBidPrice: true });
            break;
          case Shortcut.INCREASE_MAX:
            provider.increaseMaxBidPrice();
            chrome.runtime.sendMessage({ increaseMaxBidPrice: true });
            break;
          case Shortcut.INCREASE_MIN:
            provider.increaseMinBidPrice();
            chrome.runtime.sendMessage({ increaseMinBidPrice: true });
            break;
          ...
          case Shortcut.TRANSFER_LIST:
            ...
            chrome.runtime.sendMessage({ sendToTransferList: true });
            break;
        }
      });
    });
