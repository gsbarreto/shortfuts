...
import SafetySettings from "../popup/SafetySettings";
...
> {
                    ...
                    <>
                        ...
                        {this.hasError && (
                            <div className="editShortcutsError ms-fontColor-redDark">
                                All shortcuts must be single, unique characters
                                between A-Z and 0-9.
                            </div>
                        )}
                        <div className="editShortcutsList">
                            <h3 className="editShortcutsHeading">
                                Buying items
                            </h3>
                            ...
                            <div className="editShortcutsShortcut ms-borderColor-themePrimary">
                                ...
                                <TextField
                                    ...
                                    componentRef={ref =>
                                        (this.buyBronzePackTextField = ref)
                                    }
                            ...
                            <div className="editShortcutsShortcut ms-borderColor-themePrimary">
                                ...
                                <TextField
                                    ...
                                    componentRef={ref =>
                                        (this.transferListTextField = ref)
                                    }
                            ...
                            <div className="editShortcutsShortcut ms-borderColor-themePrimary">
                                ...
                                <TextField
                                    ...
                                    componentRef={ref =>
                                        (this.quickSellAllTextField = ref)
                                    }
    ...
    private saveShortcuts = () => {
        ...
        const decreaseMaxEntry = this.getShortcutEntry(
            this.decreaseMaxTextField
        );
        const decreaseMinEntry = this.getShortcutEntry(
            this.decreaseMinTextField
        );
        const increaseMaxEntry = this.getShortcutEntry(
            this.increaseMaxTextField
        );
        const increaseMinEntry = this.getShortcutEntry(
            this.increaseMinTextField
        );
        ...
        const quickSellAllEntry = this.getShortcutEntry(
            this.quickSellAllTextField
        );
        ...
        const toggleWatchEntry = this.getShortcutEntry(
            this.toggleWatchTextField
        );
        const transferListEntry = this.getShortcutEntry(
            this.transferListTextField
        );
